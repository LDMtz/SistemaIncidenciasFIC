    ...
    @auth
        <div class="flex items-center gap-4 ml-10 text-white">
            ...
            <div class="relative lg:inline-block hidden">
                ...
                <!-- Dropdown Menu -->
                <div id="dropdown-header" class="z-10 hidden bg-slate-600 divide-y rounded-b-lg w-38 absolute top-full left-0 mt-3 py-2">
                    <ul class="text-sm font-semibold text-text-1" aria-labelledby="dropdownHeaderDefaultButton">
                        <li class="m-1">
                            <a href="{{route('usuarios.perfil')}}" class="flex items-center w-full rounded px-3 py-2 hover:text-main-2 hover:bg-slate-700">
                        ...
                        <li class="m-1">
                            <a href="{{ route('notificaciones.index') }}" class="relative flex items-center w-full rounded px-3 py-2 hover:text-main-2 hover:bg-slate-700">
                        ...
                        <li class="m-1">
                            <button onclick="openModal('logoutModal')" class="flex items-center w-full rounded px-3 py-2 hover:text-main-2 hover:bg-slate-700 cursor-pointer">
