<!-- Modal Logout -->
<div id="genericDeleteModal" class="hidden">
    <div tabindex="-1" class="fixed inset-0 z-50 flex justify-center items-center bg-black/50">
        <div class="relative p-4 w-full max-w-md h-auto rounded-lg shadow dark:bg-gray-800 light:bg-gray-100 m-10">
            <div class="relative p-4 text-center">
                ...
                <p class="mb-4 text-lg font-semibold text-text-1">¿Estás seguro de eliminarlo?</p>
                <div class="mt-6 flex justify-center gap-4">
                    <!-- Botón cancelar -->
                    <button onclick="closeModal('genericDeleteModal')" type="button" class="px-4 py-2 light:bg-gray-300 dark:bg-gray-700 light:text-black dark:text-white dark:hover:bg-gray-600 light:hover:bg-gray-400 rounded">
                        No
                    </button>
