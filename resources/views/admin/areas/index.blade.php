        ...
        <div class="mx-6 lg:mx-10 flex-1 overflow-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-7 gap-10">
                ...
                <div class="lg:col-span-4 space-y-6 ">
                        ...
                        <div class="custom-scroll overflow-y-auto max-h-120 rounded-lg">
                ...
                <div class="lg:col-span-3"><!-- grid grid-rows-1 md:grid-rows-2 gap-2-->
                    ...
                    <div class="mb-5">
                        ...
                        <form action="{{ route('admin.areas.guardar') }}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="bg-slate-800 border-1 border-slate-700 rounded-lg p-4">
                                ...
                                <div class="custom-scroll bg-slate-700 text-text-1 rounded-md overflow-y-auto max-h-25">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="2" class="text-center text-sm text-slate-400 py-2">
                    ...
                    <div class="">
                        ...
                        <div class="custom-scroll overflow-y-auto max-h-40 rounded-lg">
                            <x-table :rounded="false" :shadow="false">
                                <x-slot name="headTable">
                                ...
                                <x-slot name="bodyTable">
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="3" class="text-center text-sm text-slate-400 py-2">
    ...
    <div class="flex fixed top-0 left-0 w-full h-full bg-black/50 z-50 justify-center items-center ">
        <div class="bg-slate-800 rounded-lg shadow-lg w-full max-w-md overflow-hidden border-2 border-slate-700 m-10">
            ...
            <div id="area-detalles-show" class="">
                <div class="relative bg-slate-700/60 h-8 md:h-10 px-5 border-b-2 border-slate-700">
                    ...
                    <label id="estadoActivoShow" class="hidden absolute top-15 right-7 items-center text-[0.65rem] md:text-xs font-black font-roboto leading-none">
                        ...
                        <span class="text-green-400 leading-none">ACTIVA</span>
                    </label>
                    <label id="estadoInactivoShow" class="hidden absolute top-15 right-7 items-center text-[0.65rem] md:text-xs font-black font-roboto leading-none">
                        ...
                        <span class="text-red-400 leading-none">INACTIVA</span>
                    </label>
                </div>
                ...
                <div class="p-6 mt-6 max-w-2xl w-full mx-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 text-[0.70rem] md:text-sm text-text-1">
                        ...
                        <div id="contenedorTablaShow" class="md:col-span-2">
                            ...
                            <x-table extra-classes="border-1 border-slate-700 overflow-y-auto max-h-40">
                    ...
                    <form id="formEditArea" action="" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 text-[0.70rem] md:text-sm text-text-1/60">
                            ...
                            <div id="contenedorTablaEdit" class="md:col-span-2">
                                ...
                                <x-table extra-classes="custom-scroll border-1 border-slate-700 overflow-y-auto max-h-40">
                                    <x-slot name="headTable">
            ...
            <div id="encargado-detalles-show" class="">
                <div class="relative bg-slate-700/60 h-14 md:h-17 px-5 border-b-2 border-slate-700">
                    <div class="absolute -bottom-8 md:-bottom-10">
                        <img id="fotoShowEncargado" draggable="false" class="w-16 h-16 md:w-20 md:h-20 rounded-full object-cover border-2 border-slate-700" src="" alt="Perfil">
                    </div>
