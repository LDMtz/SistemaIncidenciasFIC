...
<body class="bg-slate-900 flex items-center justify-center h-screen font-roboto">
        <div class="text-center">
            <h1 class="text-7xl sm:text-8xl md:text-9xl font-bold text-blue-500">403</h1>
            <p class="text-2xl sm:text-3xl md:text-4xl mt-3 font-semibold text-blue-300">Acceso no autorizado</p>
            <p class="text-sm sm:text-base md:text-lg mt-3 text-slate-300">No tienes permisos para acceder a esta página.</p>
