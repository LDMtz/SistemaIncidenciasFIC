...
Route::middleware("guest")->group(function(){
    ...
    Route::get('comun/usuarios/crear', [UsuarioController::class, 'create'])-> name('usuarios.crear');
    Route::post('comun/usuarios/guardar', [UsuarioController::class, 'store'])-> name('usuarios.guardar');
});
